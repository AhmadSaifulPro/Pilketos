            ...
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <h4 class="mb-5 f-w-400">Login Siswa</h4>
                        <form action="{{ route('do_loginsiswa') }}" method="post">
                            @csrf
                            <div class="form-group mb-3">
                                <label class="floating-label" for="Username">NISN</label>
                                <input type="text" class="form-control" name="nisn" id="Username" placeholder="">
                            </div>
